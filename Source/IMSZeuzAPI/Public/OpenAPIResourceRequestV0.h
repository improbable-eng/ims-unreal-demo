...
/*
 * OpenAPIResourceRequestV0
 *
 * Specifies the resource requests of a payload container. Follows the format used by Kubernetes. For more information see https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
 */
class IMSZEUZAPI_API OpenAPIResourceRequestV0 : public Model
{
public:
    virtual ~OpenAPIResourceRequestV0() {}
