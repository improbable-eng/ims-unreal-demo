...
2. How to integrate [IMS Session Manager](https://docs.ims.improbable.io/docs/ims-session-manager/getting-started) functionality into your game. (*coming soon*)
...
In order to run through the following steps, you must already have:
- An IMS project
